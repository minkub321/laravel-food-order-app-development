                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @enderror"
                                                value="{{ $account->name }}" aria-required="true" aria-invalid="false"
                                        ...
                                        <div class="form-group">
                                            ...
                                            class="form-control">Admin</option>
                                                <option value="user"  

                                              class="form-control">User</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" disabled  name="email" type="text"
                                                ...
                                                value="{{ $account->email}}" aria-required="true" aria-invalid="false"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="phone" disabled  type="text"
                                                ...
                                                value="{{ $account->phone }}" aria-required="true" aria-invalid="false"
                                                placeholder="09*********">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="address"  disabled id="" cols="30" rows="10"
                                                class="form-control @error('address') is-invalid @enderror">{{ $account->address    }}</textarea>
